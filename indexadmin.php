...
<body>
    <div class="container" style="margin-top: 30px;">
        <h3 align="center" style="margin-bottom: 20px;">Final Project Admin</h3>
        <table class="table">
        ...
        <form method="POST" id="api_form">
            ...
            <div class="form-group">
                <input type="text" name="quote" class="form-control" id="Quote" placeholder="Quote">
            </div>
            <div class="form-group">
        ...
        $(document).ready(function(){
            ...
            $('#api_form').on('submit', function(event){
                ...
                if($('Author').val() == ''){
                    ...
                    alert('The quote field is required!');
                }else if($('Category').val() == ''){
                    alert('The Category field is required!');
                }else{
